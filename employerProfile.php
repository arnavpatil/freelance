			...
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      ...
                      <?php 
                      	$sql = "SELECT * FROM job_offer WHERE e_username='$username' ORDER BY timestamp DESC";
						$result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                            // output data of each row
                            while($row = $result->fetch_assoc()) {
			...
			<div class="panel panel-primary">
			  ...
			  <div class="panel-body"><h4>
                  <table style="width:100%">
                      ...
                      <?php 
                      	$sql = "SELECT * FROM job_offer,selected WHERE job_offer.job_id=selected.job_id AND selected.e_username='$username'  ORDER BY job_offer.timestamp DESC";
						$result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                            // output data of each row
                            while($row = $result->fetch_assoc()) {
